...
{   
      ...
      void AddAnimation(std::string _animation_name, game::Texture* texture, int frame_per_row, int line, int speed, float frame_W, float frame_H) {
            texture->texRect[_animation_name] = {0, (float)(line)*frame_H, frame_W, frame_H};
            Animations[_animation_name] = new Animation(texture, _animation_name, speed, frame_per_row, frame_W, frame_H);
      }
